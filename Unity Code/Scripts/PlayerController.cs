...
public class PlayerController : MonoBehaviour {
    ...
    void MoveForearm(float[] x, float[] y, float[] z)
    {
        ...
        //    y[1] = 100.0f;
        //}
        PlayerForearm[0].localRotation = Conn.LeftForearm;//Quaternion.Euler(-x[0], -z[0], y[0]);//Good
        PlayerForearm[1].localRotation = Conn.rightForearm;//Quaternion.Euler(-x[1], -z[1], y[1]);
    }
    ...
    void MoveArm(float[] x, float[] y, float[] z)
    {
        ...
        //    z[1] = 45.0f;
        //}
        PlayerArm[0].localRotation = Conn.LeftArm;//Quaternion.Euler(-x[0], -z[0], y[0]);//Good
        PlayerArm[1].localRotation = Conn.RightArm;// Quaternion.Euler(-x[1], -z[1], y[1]);
    }
