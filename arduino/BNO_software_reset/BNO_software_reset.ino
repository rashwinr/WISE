...
q0 = map(q0,-16384,+16384,0,200);
q1 = map(q1,-16384,+16384,0,200);
q2 = map(q2,-16384,+16384,0,200);
q3 = map(q3,-16384,+16384,0,200);
Serial.println("a,"+String(q0)+","+String(q1)+","+String(q2)+","+String(q3));
