...
EC1 = plot3([2*sp,2*sp+IEC(1)],[0,IEC(2)],[0,IEC(3)],'r'); cA1 =  text(2*sp+IEC(1),IEC(2),IEC(3),ca1);
EC2 = plot3([2*sp,2*sp+JEC(1)],[0,JEC(2)],[0,JEC(3)],'g'); cA2 =  text(2*sp+JEC(1),JEC(2),JEC(3),ca2);
EC3 = plot3([2*sp,2*sp+KEC(1)],[0,KEC(2)],[0,KEC(3)],'b'); cA3 =  text(2*sp+KEC(1),KEC(2),KEC(3),ca3);
