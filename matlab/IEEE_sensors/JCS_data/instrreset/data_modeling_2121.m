...
% Import the data
tbl = readtable("F:\github\wearable-jacket\matlab\IEEE_sensors\JCS_data\instrreset\instrreset_WISE+JCS_02-04-2020 21-21.txt", opts);
...
LFE = [lse_new;lsp_new;lie_new;lps_new;lelbfe_new];
...
Lsp_Kend = corr(Lsp,Lefthand(:,1),'type','Kendall')
Lie_Kend = corr(Lie,Lefthand(:,3),'type','Kendall')
Lelbfe_Kend = corr(Lelbfe,Lefthand(:,5),'type','Kendall')
Lps_Kend = corr(Lps,Lefthand(:,4),'type','Kendall')
