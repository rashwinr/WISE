...
opts.VariableNames = ["Sensor", "Axis", "Angle", "Mean"];
opts.VariableTypes = ["string", "string", "string", "string"];
opts.ExtraColumnsRule = "ignore";
opts.EmptyLineRule = "read";

% Import the data
dataanalysispeaks = readtable("F:\github\wearable-jacket\matlab\IEEE_sensors\data_matched\dataanalysis_peaks.csv", opts);

ttpa = table2array(dataanalysispeaks);
clear opts
l = length(ttpa);
A = zeros(8,4);
B = zeros(8,4);
