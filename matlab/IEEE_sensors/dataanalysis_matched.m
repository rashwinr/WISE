...
cd(strcat('F:\github\wearable-jacket\matlab\IEEE_sensors\data_matched\LA,RA\'));
list = dir();
t1 = zeros(200,1);
q1 = zeros(200,4);
q2 = zeros(200,4);
...
sts = 'F:\github\wearable-jacket\matlab\IEEE_sensors\data_matched\LA,RA\';
for i = 3:size(list,1)
    AX(i-2) = list(i).name;
end
        ...
        for k=1:length(spike_files)
             ...
             switch f2(1)
                             ...
                             case '20'
                                 [theta1,theta2]=importangles(spike_files(k).name,[1,200]);
                                 t1 = importtime(spike_files(k).name,[1,200]);
                                 [theta1,theta2] = anglerad2degreesLARA(theta1,theta2,f2(1),AX(i),fid);
                                 figure(1)
                                 subplot(9,3,4)
                                 hold on
                                 plot(t1,theta1)
        ...
        for k=1:length(spike_files)
             ...
             switch f2(1)
                             ...
                             case '0'
                                 [theta1,theta2]=importangles(spike_files(k).name,[1,200]);
                                 t1 = importtime(spike_files(k).name,[1,200]);
                                 [theta1,theta2] = anglerad2degreesLARA(theta1,theta2,f2(1),AX(i),fid);figure(1)
                                 hold on
                                 subplot(9,3,2)
                                 plot(t1,theta1)
                                 figure(2)
