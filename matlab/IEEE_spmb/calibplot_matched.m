...
Et1 = text(-0.5-3*sp,0,-0.1,'B','FontSize',fs);
...
At1 = text(-0.5-2*sp,0,-0.1,'LF','FontSize',fs);
...
Bt1 = text(-0.5-1*sp,0,-0.1,'RB','FontSize',fs);
...
Ct1 = text(-0.50,0,-0.1,'LA','FontSize',fs);
...
Dt1 = text(sp-0.50,0,-0.1,'RA','FontSize',fs);
...
plot([-5.5,5.5],[0,0],'k--');
plot([0,0],[-5.5,5.5],'k--');
Cl1 = plot([0,0.25*R*cos(gaq(1))],[0,0.25*R*sin(gaq(1))],'r','DisplayName','LF','LineWidth',lw);
Cl2 = plot([0.25*R*cos(gaq(2)),0.5*R*cos(gaq(2))],[0.25*R*sin(gaq(2)),0.5*R*sin(gaq(2))],'g','DisplayName','RF','LineWidth',lw);
Cl3 = plot([0.5*R*cos(gaq(3)),0.75*R*cos(gaq(3))],[0.5*R*sin(gaq(3)),0.75*R*sin(gaq(3))],'y','DisplayName','LA','LineWidth',lw);
Cl4 = plot([0.75*R*cos(gaq(4)),R*cos(gaq(4))],[0.75*R*sin(gaq(4)),R*sin(gaq(4))],'b','DisplayName','RA','LineWidth',lw);
t16 = text(5.5,0,'0^o     X_B','FontSize',fs);
t17 = text(-7,0,'180^o','FontSize',fs);
t18 = text(0,+6,'90^o     Z_B','FontSize',fs);
t19 = text(0,-6,'-90^o','FontSize',fs);
t20 = text(-7,7.5,strcat('LF:   ',num2str(gaq(1)*180/pi),'^{o}'),'FontSize',fs);
t21 = text(-3,7.5,strcat('RF:   ',num2str(gaq(2)*180/pi),'^{o}'),'FontSize',fs);
t22 = text(1,7.5,strcat('LA:   ',num2str(gaq(3)*180/pi),'^{o}'),'FontSize',fs);
t23 = text(5,7.5,strcat('RA:   ',num2str(gaq(4)*180/pi),'^{o}'),'FontSize',fs);
set(gca,'YTick',[]);
set(gca,'XTick',[]);
set(gca,'ZTick',[]);
set(gca,'Yticklabel',[]); 
