...
tic;
    switch (WISESENSORID)
        ...
        case 'B'
           [q3,q2,q4,q5,q1] = DataReceive_matched(ser,q3,q2,q4,q5,q1); 
        case 'C'
           [q4,q3,q2,q5,q1] = DataReceive_matched(ser,q4,q3,q2,q5,q1); 
        case 'D'
           [q5,q3,q4,q2,q1] = DataReceive_matched(ser,q5,q3,q4,q2,q1); 
        case 'E'
           [q1,q3,q4,q5,q2] = DataReceive_matched(ser,q1,q3,q4,q5,q2); 
    end
