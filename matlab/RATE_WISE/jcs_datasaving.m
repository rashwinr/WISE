...
addpath('F:\github\wearable-jacket\matlab\RATE_WISE');
instrreset
ser = serial('COM15','BaudRate',115200);
ser.ReadAsyncMode = 'continuous';
fopen(ser);
addpath('F:\github\wearable-jacket\matlab\RATE_WISE\JCS_data\');
sts = 'F:\github\wearable-jacket\matlab\RATE_WISE\JCS_data\';
