...
Xb = [dot(Vxb(2:4),Vxa_(2:4)),dot(Vxb(2:4),Vya_(2:4)),dot(Vxb(2:4),Vza(2:4))];
Yb = [dot(Vyb(2:4),Vxa_(2:4)),dot(Vyb(2:4),Vya_(2:4)),dot(Vyb(2:4),Vza(2:4))];
Zb = [dot(Vzb(2:4),Vxa_(2:4)),dot(Vzb(2:4),Vya_(2:4)),dot(Vzb(2:4),Vza(2:4))];
